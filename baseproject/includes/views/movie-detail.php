<div class="row">
    ...
    <form method="<?php if($this->id): ?>put<?php else: ?>post<?php endif; ?>" action="api/movie/" class="col-xs-12">
        ...
        <div class="form-group">
            ...
            <input type="text" name="movie_name" class="form-control" id="movie_name" value="<?php echo $this->movie_name; ?>" readonly>
        </div>
        <div class="form-group">
            <label for="director">Regisseur:</label>
            <input type="text" name="director" class="form-control" id="director" value="<?php echo $this->director; ?>" readonly>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="imdb_id" class="form-control" id="imdb_id" value="<?php echo $this->imdb_id; ?>" readonly>
        </div>
        <div class="form-group">
            <label for="imdb_link">imdb-link:</label>
            <input type="text" name="imdb_link" class="form-control" id="imdb_link" value="http://www.imdb.com/title/<?php echo $this->imdb_id; ?>" readonly>
        </div>
